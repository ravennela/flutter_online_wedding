...
class ApiConstants {
  ...
  static String get updateBookingStatus => "$baseUrl/admin/bookings/{id}/status";
  ...
  static String get assignVendors => "$baseUrl/admin/bookings/{id}/assign-vendors";
  static String get deAssignVendor => "$baseUrl/admin/bookings/{id}/vendors/{vendorId}";
  ...
  static String get publicDecorationDetail => '$baseUrl/api/public/decorations/{id}';
  ...
  static String get vendorAcceptedBookings => '$baseUrl/vendor/bookings/accepted';
  static String get vendorCompletedBookings => '$baseUrl/vendor/bookings/completed';
  static String get vendorAcceptBooking => '$baseUrl/vendor/bookings/{id}/accept';
  static String get vendorCompleteBooking => '$baseUrl/vendor/bookings/{id}/complete';
